...
from sample.grpc import sample_pb2 as grpc_dot_sample__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in grpc/sample_pb2_grpc.py depends on'
...
class MatchesControllerStub(object):
...
def add_MatchesControllerServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'matches.MatchesController', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('matches.MatchesController', rpc_method_handlers)
